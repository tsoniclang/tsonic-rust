...
import { Node_Type } from "../../common/source-ast.js";
import type {
...
import { selectRustProviderOperation } from "./provider-operation-selection.js";
...
function providerDisposalTargetIsSupported(
  target: import("../rust-facts/keys.js").RustProviderOperationForm,
): boolean {
