...
import { closedMetadataKey, isDenseDataArray } from "../../common/closed-metadata.js";
...
import type { RustProjectMethodDispatchPlan } from "./project-method-dispatch.js";
import type {
  RustProjectTypeDefinition,
  RustProjectTypePolicy,
} from "./project-type-policy.js";
import { selectRustValueCarrierReconciliation } from "./value-carrier-reconciliation.js";
...
function sourceCallableParameterAbis(
  input: { readonly ast: AstReader; readonly facts: RustSemanticModel },
  callable: Node,
...
function sourceCallableReturnCarrier(
  input: { readonly facts: RustSemanticModel },
  callable: Node,
  substitutions: ReadonlyMap<string, TargetTypeRef>,
