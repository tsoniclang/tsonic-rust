...
export const jsOperationRows = defineJsOperationRows([
  ...
  ...(["RegExpExecArray", "RegExpMatchArray", "Array", "ReadonlyArray"] as const).flatMap((owner): readonly JsOperationRowData[] => [
    { owner, member: "length", operationKind: "property", lane: "regexp-match", shape: { op: "operation", operationKind: "property", target: { form: "receiver-method", name: "len" }, evaluation: "pure", result: { ref: "int32" }, resultConversion: rustUsizeToInt32ValueConversion } },
    { owner, member: "index", operationKind: "indexer", lane: "regexp-match", shape: { op: "operation", operationKind: "indexer", target: { form: "receiver-method", name: "group", argModes: ["value"], argConversions: [rustInt32ToUsizeValueConversion] }, evaluation: "pure", result: { ref: "option-of-string" }, params: [{ ref: "int32" }] } },
  ]),
