...
export const jsOperationRows = defineJsOperationRows([
  ...
  { owner: "ObjectConstructor", member: "freeze", operationKind: "call", lane: "object", shape: { op: "operation", operationKind: "method", target: { form: "call", path: "tsonic_rust_runtime::EmptyObject::freeze", argModes: ["ref"] }, result: { ref: "empty-object" }, params: [{ ref: "empty-object" }] } },
  { owner: "ObjectConstructor", member: "isFrozen", operationKind: "call", lane: "object", shape: { op: "operation", operationKind: "method", target: { form: "call", path: "tsonic_rust_runtime::EmptyObject::is_frozen", argModes: ["ref"] }, result: { ref: "bool" }, params: [{ ref: "empty-object" }] } },
