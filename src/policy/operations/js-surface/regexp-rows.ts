...
const regexpCallRows: readonly JsOperationRowData[] = [
  ...
  { owner: owners.regExpConstructor, member: "call", operationKind: "call", lane: "regexp", variant: "exact-undefined-flags", firstArgCarrierId: rustJsStringTargetId, fallible: true, shape: { op: "operation", operationKind: "method", target: { form: "call", path: "js_abi::regexp_from_exact_with_undefined_flags", argModes: ["ref", "value"] }, result: { ref: "regexp" }, params: [{ ref: "js-string" }, { ref: "absence" }] } },
  { owner: owners.regExpConstructor, member: "call", operationKind: "call", lane: "regexp", variant: "undefined", firstArgCarrierId: rustAbsenceTargetId, fallible: true, shape: { op: "operation", operationKind: "method", target: { form: "call", path: "js_abi::regexp_from_undefined_native" }, result: { ref: "regexp" }, params: [{ ref: "absence" }] } },
  { owner: owners.regExpConstructor, member: "call", operationKind: "call", lane: "regexp", variant: "undefined-flags", firstArgCarrierId: rustAbsenceTargetId, fallible: true, shape: { op: "operation", operationKind: "method", target: { form: "call", path: "js_abi::regexp_from_undefined_with_flags_native", argModes: ["value", "ref"] }, result: { ref: "regexp" }, params: [{ ref: "absence" }, { ref: "string" }] } },
  { owner: owners.regExpConstructor, member: "call", operationKind: "call", lane: "regexp", variant: "undefined-undefined-flags", firstArgCarrierId: rustAbsenceTargetId, fallible: true, shape: { op: "operation", operationKind: "method", target: { form: "call", path: "js_abi::regexp_from_undefined_with_undefined_flags_native" }, result: { ref: "regexp" }, params: [{ ref: "absence" }, { ref: "absence" }] } },
...
function regexpResultRows(policy: StringLanePolicy): readonly JsOperationRowData[] {
  ...
  return [
    ...
    { owner: resultOwners.exec, member: resultMembers.index, operationKind: "property", lane: "js-array", shape: { op: "operation", operationKind: "property", target: { form: "receiver-method", name: "index" }, result: { ref: "native-uint" } } },
    ...
    { owner: resultOwners.match, member: resultMembers.index, operationKind: "property", lane: "js-array", shape: { op: "operation", operationKind: "property", target: { form: "receiver-method", name: "index" }, result: { ref: "option-of-native-uint" }, sourceResult: { ref: "native-uint" }, sourceAbsence: "undefined" } },
...
function regexpMethodRows(policy: StringLanePolicy): readonly JsOperationRowData[] {
  ...
  return [
    ...
    { owner: owners.regExp, member: symbols.search, operationKind: "call", lane: "regexp", firstArgCarrierId: policy.carrierId, fallible: true, shape: { op: "operation", operationKind: "method", target: target("search"), result: { ref: "native-int" }, params: [policy.value] } },
...
function stringRegExpRows(policy: StringLanePolicy): readonly JsOperationRowData[] {
  ...
  return [
    ...
    { owner: policy.sourceOwner, member: stringMembers.search, operationKind: "call", lane, firstArgCarrierId: rustJsRegExpTargetId, fallible: true, shape: { op: "operation", operationKind: "method", target: call("string_search_regexp", ["ref"]), result: { ref: "native-int" }, params: [{ ref: "regexp" }] } },
