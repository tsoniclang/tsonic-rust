...
const regexpCallRows: readonly JsOperationRowData[] = [
  ...
  { owner: owners.regExpConstructor, member: "call", operationKind: "call", lane: "regexp", variant: "undefined", firstArgCarrierId: rustAbsenceTargetId, fallible: true, shape: { op: "operation", operationKind: "method", target: { form: "call", path: "js_abi::regexp_from_undefined_native" }, result: { ref: "regexp" }, params: [{ ref: "undefined" }] } },
