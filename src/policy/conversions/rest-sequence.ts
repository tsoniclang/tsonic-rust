...
export function selectRustRestSequenceConversion(
  ...
  const conversions = sequence.elements.map(element => selectRustSourceValueConversion(element, elementTarget));
  ...
  return rustValueConversionContract(conversion) === undefined ? undefined : conversion;
}
