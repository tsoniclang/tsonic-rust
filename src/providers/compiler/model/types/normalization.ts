...
import type { ResolvedRustdocItem } from "../rustdoc-items.js";
import type {
...
import {
  childCompilerNormalizationContext as childContext,
  normalizeCompilerLifetime as normalizeLifetime,
  stripRustLifetimeName as stripLifetime,
  type RustCompilerNormalizationContext,
} from "./normalization-context.js";
import {
  compareRustCompilerCaptures,
  normalizeRustCompilerCapture as normalizeCapture,
  requiredRustOpaqueCaptureKeys,
  rustCompilerCaptureIdentityKey,
} from "./opaque-captures.js";

export { exactAssociatedTypeIdentity } from "./trait-resolution.js";
export type { RustCompilerNormalizationContext } from "./normalization-context.js";
