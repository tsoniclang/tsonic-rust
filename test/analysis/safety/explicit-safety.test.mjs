...
`,
  ...
  assert.match(source, /unsafe fn dispatch_box_read\(self: alloc::rc::Rc<Self>\) -> i32/u);
...
`,
  ...
  assert.match(
    text,
    /unsafe fn read_value_current\(self: alloc::rc::Rc<Self>\) -> i32/u,
  );
  assert.match(
    text,
    /unsafe fn write_value_current\(self: alloc::rc::Rc<Self>, value: i32\)/u,
  );
