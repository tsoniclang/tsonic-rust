            ...
            args: [{
              ...
              owner: {
                ...
                genericArguments: [{
                  ...
                  kind: "type",
                  type: { kind: "named", path: "rt::TsonicResult<String>" },
                }],
              },
              method: "new",
              args: [{
...
test("rustfmt canonicalizes long callable construction with expression callbacks", () => {
  const source = printRustSourceFile({
    headerComment,
    items: [{
      kind: "function",
            ...
            args: [{
              ...
              owner: {
                ...
                genericArguments: [
                  ...
                  {
                    kind: "type",
                    type: { kind: "named", path: "rt::TsonicResult<()>" },
                  },
                ],
              },
              method: "new",
